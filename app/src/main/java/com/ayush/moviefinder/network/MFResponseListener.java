...
import com.ayush.moviefinder.model.ApiErrorResponse;
 ...
 */
public class MFResponseListener<T> implements Callback<T> {
    private WeakReference<Context> mActivityContext;
    private static List<MFResponseListener> requestList = new ArrayList<>();
    private boolean isCancelled = false;
    private WeakReference<ResponseListener> mResponseListenerWeakReference;

    public MFResponseListener(Context context) {
